...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{MW-M31sep.png}
...
The velocity dispersion does tend to increase at larger radii. This agrees with the hypothesis that as the two galaxies interact there should be an increase in the velocity dispersion of the galaxy. The velocity dispersion calculated at the farthest radii (24-30 kpc) increase from 5.7 km/s to 55.9 km/s. This is a significant increase in velocity dispersion for the particles that are farther from the center of MW.
...
In the analysis of the data the biggest source of error likely came from the calculation of velocity dispersion. There were two methods used to calculate dispersion which resulted in two different results. The first method calculates the 3D velocity and then finds dispersion of that velocity and the second method calculate the dispersion of each component of the velocity and then finds the magnitude of the dispersion. The second method was utilized in this study. An additional source of error comes from neglecting the effects of M33 which is also present in the simulation. Becuase M33 has a gravitational influence on the particles in the simulation it is causing some change in the velocities of the particles in MW.

...
#it takes a file name as a string, particle type as a float, and specific particle as an int number as inputs
...
def ParticleInfo(filename, particle_type, particle_number):
	...
	index = np.where(data['type'] == particle_type) #creates an index to only look at particles of a specific type
	...
	mass = mnew[particle_number]*(10**10)*u.M_sun
	return dist_mag, vel_mag, mass

#testing the function works
#test_dist, test_vel, test_mass = ParticleInfo('MW_000.txt', 2, 99)

...
class M33AnalyticOrbit:
    ...
    def __init__(self, filename):
        ...
        self.Vc = 180 #circular speed of M31 halo in km/s
    ...
    def DynamicalFriction(self, MSat, Vc, r, v):
        '''
        This method returns decarlation from dynamical friction felt by M33 (in this case)
        by its motion through the halo of M31.
        inputs:
            Msat: float, mass of satellite in Msun
            Vc: float, maximum circular velocity of the host halo in km/s
            r: n dimensional array, position vector of the satellite relative to host
            v: n dimensional array, vector of the satellite relative to the host in km/s
        output:
            DF: n dimensinoal array, deceleration vector due to dynamicla friction
        '''
        #magnitude of the stellite's positin vector
        r_mag = np.sqrt(r[0]**2 + r[1]**2 + r[2]**2)


        #magnitude of the satellites velocity vector
    ...
    def M31Accel(self, r, v):
        ...
        r : `np.ndarray`
            Position vector to find the acceleration at
        v : 'np.ndarray'
            velocity vector to find the acceleratino at
...
if __name__ == '__main__':
    ...
    ax.plot(M33Orbit['t'], M31_M33_R, 'g', lw=5, label='M31-M33 with DF')
    ...
    ax.plot(M33Orbit['t'], M31_M33_V, 'g', lw=5, label='M31-M33 with DF')

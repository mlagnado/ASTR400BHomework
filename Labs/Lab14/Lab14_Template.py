...
print(np.round(data['z'][0],3))
print(np.round(data['DistMod'][0],3))
...
legend = ax.legend(loc='upper left',fontsize=18)
plt.savefig('LuminosityDistance.png')
plt.show()
...
# plot nearby SNe
ax.plot(VR[near], LD[near], 'b.', label='SNe Data')
ax.plot(VR[near], modelLD[near], 'r', label='VR/H0')
ax.set_xlabel('Recessional velocity [km/s]', fontsize=18)
ax.set_ylabel('Luminosity Distance [Mpc]', fontsize=18)
ax.set_title(f"Luminosity Distance vs Recessional Velocity for {nNear} SNe within 200 Mpc",
             fontsize=15)
...
legend = ax.legend(loc='upper left',fontsize=18)
plt.savefig('LuminosityDistance_wLinear.png')
plt.show()
...
legend = ax.legend(loc='upper left',fontsize=18)
plt.savefig('LuminosityDistance_wLinear_AllData.png')
plt.show()

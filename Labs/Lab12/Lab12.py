...
class CosmologicalTools:
    ...
    def ComovingDistance(self, zo, ze):
        ...
        # FILL THIS IN
        c_kms = c.to(u.km/u.s)
        y = c_kms/self.HubbleParameter(zrange)#integrand
...
# How many Gyr ago was z=1 in the Benchmark cosmology?
benchmark_lookback = Benchmark.LookBackTime(1)
print(np.round(benchmark_lookback,4))
...
benchmark_univ_age = Benchmark.LookBackTime(100) #don't use too large of a z or else runtime will be large because we are numerically integrating
print(np.round(benchmark_univ_age,4))

# In[ ]:


# What is the Age of the Universe in the Einstein De Sitter Cosmology
Desitter_univ_age = Desitter.LookBackTime(100)
print(np.round(Desitter_univ_age,4))

# In[ ]:


# Which is younger?
print('The Desitter universe is younger')
...
print(np.round(Benchmark.ProperDistance(0,1000),3))
...
print(np.round(Benchmark.ComovingDistance(0,1000),3))
...
print(np.round(Desitter.ProperDistance(0,1000),3))
...
print('The Benchmark universe is larger')
print('# D #')
# ## Question 2 D)
...
# What is the size of the observable universe at z=2? 
print(np.round(Benchmark.ProperDistance(2,1000),3))

# In[ ]:


# how much larger was the universe then vs now?
print('The universe was about 5 times larger')
print('# F #')
# ##  Question 2 F)
# Plot the Horizon Distance as a Function of Redshift out to z=10 for the BenchMark and Einstein DeSitter Cosmology
# 
